...
///
/// Mirrors the two corner variants documented in the Finesse UI Kit for icon buttons. Unlike [ButtonCorner], [smooth] does not use a single fixed radius — it scales with the button's [IconButtonSize] (see the table on that enum).
