...
///
/// Each value carries its natural design width (height is always 48 px in the source Figma file) and the ordered list of SVG layers that compose the logo. Use [GHCompanyLogo] to render any variant.
enum GHCompany {
