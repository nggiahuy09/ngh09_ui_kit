...
///
/// Provide [label], [icon], or both, matching the Finesse "Only Text", "Text & Icon" and "Only Icon" segment types.
class GHSegmentedControlItem {
  ...
  ///
  /// Rendered at 20dp when [label] is `null` (icon-only), or 16dp alongside a label.
  final Widget? icon;
}
