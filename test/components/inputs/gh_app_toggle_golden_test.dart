...
void main() {
  group('GHAppToggle golden', () {
    goldenTest(
      'sizes — unchecked and checked',
      fileName: 'app_toggle_sizes',
    ...
    goldenTest(
      'states',
      fileName: 'app_toggle_states',
      builder: () => GoldenTestGroup(
        columns: 2,
        children: [
          GoldenTestScenario(
            name: 'enabled off',
            child: _themed(GHAppToggle(value: false, onChanged: (_) {}), brightness: Brightness.light),
          ),
          GoldenTestScenario(
            name: 'enabled on',
            child: _themed(GHAppToggle(value: true, onChanged: (_) {}), brightness: Brightness.light),
          ),
          GoldenTestScenario(
            name: 'disabled off',
            child: _themed(const GHAppToggle(value: false, onChanged: null), brightness: Brightness.light),
          ),
          GoldenTestScenario(
            name: 'disabled on',
            child: _themed(const GHAppToggle(value: true, onChanged: null), brightness: Brightness.light),
          ),
        ],
      ),
    );
